...
public class BookForm extends TabActivity {
   ...
   // made public to be accessible from driver
   public Button saveButton;
   public Button selectCoverButton;
   public Button retrieveCoverButton;
   public Button generateCoverButton;
   ...
   public void onCreate(final Bundle savedInstanceState) {
      ...
      bookEnterEditLabel = (TextView) findViewById(R.id.bookentereditlabel, TextView.class);
      bookCover = (ImageView) findViewById(R.id.bookcover, ImageView.class);
      bookTitleFormTab = (EditText) findViewById(R.id.booktitleform, EditText.class);
      bookTitleCoverTab = (TextView) findViewById(R.id.booktitlecover, TextView.class);
      bookSubTitle = (EditText) findViewById(R.id.booksubtitle, EditText.class);
      bookIsbn10 = (EditText) findViewById(R.id.bookisbn10, EditText.class);
      bookIsbn13 = (EditText) findViewById(R.id.bookisbn13, EditText.class);
      bookAuthors = (EditText) findViewById(R.id.bookauthors, EditText.class);
      bookSubject = (EditText) findViewById(R.id.booksubject, EditText.class);
      bookDatePub = (DatePicker) findViewById(R.id.bookdatepub, DatePicker.class);
      bookPublisher = (EditText) findViewById(R.id.bookpublisher, EditText.class);

      saveButton = (Button) findViewById(R.id.bookformsavebutton, Button.class);
      ...
      selectCoverButton = (Button) findViewById(R.id.bookformselectcoverbutton, Button.class);
      ...
      retrieveCoverButton = (Button) findViewById(R.id.bookformretrievecoverbutton, Button.class);
      ...
      generateCoverButton = (Button) findViewById(R.id.bookformgeneratecoverbutton, Button.class);
