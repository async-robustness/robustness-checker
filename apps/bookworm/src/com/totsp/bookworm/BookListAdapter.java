...
public class BookListAdapter extends ArrayAdapter<Book> {
   ...
   public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (item == null) {
         ...
         holder.text1 = (TextView) item.findViewById(R.id.book_item_text_1, TextView.class);
         holder.text2 = (TextView) item.findViewById(R.id.book_item_text_2, TextView.class);
         item.setTag(holder);
      }
