...
public class Main extends Activity {
   ...
   public ImageView addScanImage;
   public ImageView addSearchImage;
   public ImageView addFormImage;
   public ImageView manageDataImage;
   ...
   public AlertDialog manageDataDialog;
   public AlertDialog statsDialog;
   ...
   public void onCreate(final Bundle savedInstanceState) {
      ...
      // action bar images
      sortImage = (ImageView) findViewById(R.id.actionsort, ImageView.class);
      ...
      addScanImage = (ImageView) findViewById(R.id.actionaddscan, ImageView.class);
      ...
      addSearchImage = (ImageView) findViewById(R.id.actionaddsearch, ImageView.class);
      ...
      addFormImage = (ImageView) findViewById(R.id.actionaddform, ImageView.class);
      ...
      manageDataImage = (ImageView) findViewById(R.id.actionmanagedata, ImageView.class);
      ...
      // listview
      bookListView = (ListView) findViewById(R.id.booklistview, ListView.class);
      bookListView.setEmptyView(findViewById(R.id.empty, View.class));
   ...
   private class BookCursorAdapter extends CursorAdapter implements FilterQueryProvider {
      ...
      public View newView(final Context context, final Cursor c, final ViewGroup parent) {
         ...
         holder.coverImage = (ImageView) v.findViewById(R.id.list_items_item_image, ImageView.class);
         holder.ratingImage = (ImageView) v.findViewById(R.id.list_items_item_rating_image, ImageView.class);
         holder.text1 = (TextView) v.findViewById(R.id.list_items_item_text1, TextView.class);
         holder.text2 = (TextView) v.findViewById(R.id.list_items_item_text2, TextView.class);
         holder.readStatus = (CheckBox) v.findViewById(R.id.list_items_item_read_status, CheckBox.class);
         v.setTag(holder);
         populateView(v, c);
         return v;
      }
