...
public class BookSearch extends Activity {
   ...
   public void onCreate(final Bundle savedInstanceState) {
      ...
      searchInput = (EditText) findViewById(R.id.bookentrysearchinput, EditText.class);
      ...
      searchButton = (Button) findViewById(R.id.bookentrysearchbutton, Button.class);
      ...
      searchResults = (ListView) findViewById(R.id.bookentrysearchresultlist, ListView.class);
