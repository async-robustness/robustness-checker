...
public class CsvImport extends Activity {
   ...
   public void onCreate(final Bundle savedInstanceState) {
      ...
      application = (BookWormApplication) getApplication(); // TODO getApplication() will take Class param
      ...
      parseButton = (Button) findViewById(R.id.bookimportparsebutton, Button.class);
      importButton = (Button) findViewById(R.id.bookimportimportbutton, Button.class);
      importButton.setEnabled(false);

      helpButton = (Button) findViewById(R.id.bookimporthelpbutton, Button.class);

      importMeta = (TextView) findViewById(R.id.bookimportmeta, TextView.class);

      books = new ArrayList<Book>();

      listView = (ListView) findViewById(R.id.bookimportlistview, ListView.class);
