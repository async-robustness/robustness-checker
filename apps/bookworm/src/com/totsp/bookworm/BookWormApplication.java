...
public class BookWormApplication extends Application {
   ...
   // made public to be accessible from the driver
   ...
   void establishBookDataSourceFromProvider() {
      ...
      //ROB Remove reflection:
      bookDataSource = new GoogleBookDataSource(this);
      ...
      try {
         ...
         Log.e(Constants.LOG_TAG, e.getMessage(), e);
         throw new RuntimeException(e);//"Error, unable to establish data provider. " + e.getMessage());
