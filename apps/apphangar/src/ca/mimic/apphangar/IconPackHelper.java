...
public class IconPackHelper {
    ...
    public static Map<String, String> getIconPackResources(Context context, String packageName) {
        ...
        if (arrayId != 0) {
            ...
            //loadApplicationResources(context, iconPackResources, packageName); // reflection
        }
        return iconPackResources;
    }
    ...
    public static AlertDialog alertDialog; //made public to be accessible
    ...
    public static void pickIconPack(final Context context, final boolean isPicker, final boolean moreAppIcon) {
        ...
        builder.setAdapter(adapter, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int position) {
                ...
                prefs = new Settings.PrefsGet(context.getSharedPreferences(context.getPackageName(), Context.MODE_MULTI_PROCESS)); //write pref
                ...
                // commented out deleying cached icons
        ...
        if (isPicker) {
            ...
            if (needsWarning) {
                LinearLayout iconPackWarning = (LinearLayout) alertDialog.getLayoutInflater().inflate(R.layout.iconpack_main, null, LinearLayout.class);
                TextView tv = (TextView) iconPackWarning.findViewById(R.id.iconpack_warning, TextView.class);
                tv.setText(alertTxt);
    ...
    private static class IconAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView txtView = (TextView) convertView.findViewById(R.id.title, TextView.class);
            txtView.setText(info.label);
            ImageView imgView = (ImageView) convertView.findViewById(R.id.icon, ImageView.class);
            imgView.setImageDrawable(info.icon);
            ImageView chk = (ImageView) convertView.findViewById(R.id.check, ImageView.class);
