...
public class Contribute {
    ...
    protected View getView() {
        ...
        TextView mGoogle = (TextView) mContribute.findViewById(R.id.contribute_google, TextView.class);
        mGoogle.setPaintFlags(0);
        ...
        TextView mGithub = (TextView) mContribute.findViewById(R.id.contribute_code, TextView.class);
        mGithub.setPaintFlags(0);
        ...
        TextView mCrowdin = (TextView) mContribute.findViewById(R.id.contribute_translate, TextView.class);
        mCrowdin.setPaintFlags(0);
        ...
        TextView mPlus = (TextView) mContribute.findViewById(R.id.contribute_plus, TextView.class);
        mPlus.setPaintFlags(0);
