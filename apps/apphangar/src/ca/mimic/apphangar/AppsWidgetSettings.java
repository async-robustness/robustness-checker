...
public class AppsWidgetSettings extends PreferenceActivity {
    ...
    public static class StatsWidgetFragment extends PreferenceFragment {
        ...
        public void savePrefs() {
            ...
            mEditor.putInt(Settings.ICON_COLOR_PREFERENCE, 0);
        ...
        public void onCreate(final Bundle savedInstanceState)
        {
            ...
            weighted_recents_preference = (CheckBoxPreference)findPreference(Settings.WEIGHTED_RECENTS_PREFERENCE, CheckBoxPreference.class);
            ...
            weight_priority_preference = (UpdatingListPreference)findPreference(Settings.WEIGHT_PRIORITY_PREFERENCE, UpdatingListPreference.class);
            ...
            colorize_preference = (CheckBoxPreference)findPreference(Settings.COLORIZE_PREFERENCE, CheckBoxPreference.class);
            ...
            ignore_pinned_preference = (CheckBoxPreference)findPreference(Settings.IGNORE_PINNED_PREFERENCE, CheckBoxPreference.class);
            ...
            icon_size_preference = (UpdatingListPreference)findPreference(Settings.ICON_SIZE_PREFERENCE, UpdatingListPreference.class);
