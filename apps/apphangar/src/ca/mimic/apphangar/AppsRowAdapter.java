...
public class AppsRowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.rowCont = (LinearLayout) convertView.findViewById(R.id.row_cont, LinearLayout.class);
            holder.taskIcon = (ImageView) convertView.findViewById(R.id.task_icon, ImageView.class);
            holder.pinIcon = (ImageView) convertView.findViewById(R.id.pin_icon, ImageView.class);
            holder.barCont = (LinearLayout) convertView.findViewById(R.id.bar_cont, LinearLayout.class);
            holder.taskName = (TextView) convertView.findViewById(R.id.task_name, TextView.class);
            holder.useStats = (TextView) convertView.findViewById(R.id.use_stats, TextView.class);
        ...
        holder.taskName.setTextColor(taskNameColor);
        ...
        holder.taskName.setPaintFlags(holder.taskName.getPaintFlags());
        if (completeRedraw) {
    ...
    public void fadeCross(View view) {
        TextView text = (TextView) view.findViewById(R.id.task_name, TextView.class);
