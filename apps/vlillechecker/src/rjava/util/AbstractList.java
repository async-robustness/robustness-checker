...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E> {
    ...
    private static class SubAbstractList<E> extends AbstractList<E> {
        ...
        protected void removeRange(int start, int end) {
            if (start != end) {
                ...
                if (modCount == fullList.modCount) {
                    ...
                    /*if(TraceRecorder.isInitialized()) {
                        TraceRecorder.record("GET", Integer.toHexString(System.identityHashCode(fullList)), "java.util.AbstractList", "modCount", "removeRange");
                        //TraceRecorder.record("PUT", Integer.toHexString(System.identityHashCode(this)), "java.util.AbstractList$SubAbstractList", "modCount", "removeRange");
                    }*/
                    /** async-robustness check **/
        ...
        public int size() {
            ...
            //System.out.println("Reads: " + Integer.toHexString(System.identityHashCode(fullList)) + "  java.util.AbstractList   modCount");
