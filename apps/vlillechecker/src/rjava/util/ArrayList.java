...
public class ArrayList<E> extends AbstractList<E> implements Cloneable, Serializable, RandomAccess {
    ...
    public ArrayList(int capacity) {
        //System.out.println("-------------created new arraylist with capacity");
        if (capacity < 0) {
     ...
     */
    public ArrayList() {
        //System.out.println("-------------created new arraylist from scratch");
    ...
    public ArrayList(Collection<? extends E> collection) {
        //System.out.println("-------------created new arraylist from collection");
    ...
    @Override public E remove(int index) {
        ...
        //System.out.println("Remove r/w: " + Integer.toHexString(System.identityHashCode(this)) + "  java.util.List   modCount");
    ...
    private class ArrayListIterator implements Iterator<E> {
        ...
        public void remove() {
            ...
            //DetViolationChecker.instStatementJPF("GET", Integer.toHexString(System.identityHashCode(ArrayList.this)), "java.util.List$ArrayListIterator", "modCount", "remove");
            //SerViolationChecker.instStatement("GET", Integer.toHexString(System.identityHashCode(ArrayList.this)), "java.util.List$ArrayListIterator", "modCount", "remove");
