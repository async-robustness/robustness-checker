...
public class SearchActivity extends MenuListActivity {
	...
	public EditText mSearchText; // made public to be accessible from the driver code
	private Cursor mCsr;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB /* 11 */) {
			...
			final Button search = (Button) findViewById(R.id.button_search, Button.class);
			if (search != null) {
		...
		mSearchText = (EditText) findViewById(R.id.searchtext, EditText.class);
	...
	void DoSearch(int Id, Intent intent) {
		...
		if (Id == R.id.button_searchstops) {
			...
			if (lv.getFooterViewsCount() > 0) {
				final TextView tv = (TextView) findViewById(R.id.about_credits, TextView.class);
				if (tv != null) {
