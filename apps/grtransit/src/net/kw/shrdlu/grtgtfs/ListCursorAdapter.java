...
public class ListCursorAdapter extends CursorAdapter {
	...
	public void bindView(View view, Context context, Cursor cursor) {
		...
		final TextView labelview = (TextView) view.findViewById(R.id.label, TextView.class);
		final String item = cursor.getString(cursor.getColumnIndex("_id"));

		final TextView valueview = (TextView) view.findViewById(R.id.value, TextView.class);
		final String descr = cursor.getString(cursor.getColumnIndex("descr"));

		final TextView timeview;
		final String time;
		if (mLayout == R.layout.timestopdesc) {
			timeview = (TextView) view.findViewById(R.id.stoptime, TextView.class);
