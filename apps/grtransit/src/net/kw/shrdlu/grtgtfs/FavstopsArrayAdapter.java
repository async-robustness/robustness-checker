...
public class FavstopsArrayAdapter extends ArrayAdapter /* <ArrayList<String[]>> */{
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			holder.stoplabel = (TextView) view.findViewById(R.id.stoplabel, TextView.class);
			holder.stopdesc = (TextView) view.findViewById(R.id.stopdesc, TextView.class);
			holder.stoptime = (TextView) view.findViewById(R.id.stoptime, TextView.class);
			holder.routelabel = (TextView) view.findViewById(R.id.routelabel, TextView.class);
			holder.routedesc = (TextView) view.findViewById(R.id.routedesc, TextView.class);
			view.setTag(holder);
		} else {
