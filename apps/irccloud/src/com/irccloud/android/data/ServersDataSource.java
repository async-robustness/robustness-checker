...
public class ServersDataSource {
	...
	public Server createServer(int cid, String name, String hostname, int port, String nick, String status, long lag, int ssl, String realname, String server_pass, String nickserv_pass, String join_commands, Object fail_info, String away, Object ignores, int order) {
	...
	public void updateStatus(int cid, String status, Object fail_info) {
		Server s = getServer(cid);
		if(s != null) {
			s.status = status;
			s.fail_info = fail_info;
	...
	public void updateIsupport(int cid, Object params) {
		/*Server s = getServer(cid);
		if(s != null) {
	...
	public void updateIgnores(int cid, Object ignores) {
		/*Server s = getServer(cid);
		if(s != null) {
