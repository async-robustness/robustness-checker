...
public class BuffersListFragment extends ListFragment {
	...
	private class BufferListAdapter extends BaseAdapter {
		...
		public BufferListAdapter(ListFragment context) {
            ...
            eightdp = 0; //(int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, getResources().getDisplayMetrics());
		}
		...
		public BufferListEntry buildItem(int cid, int bid, int type, String name, int key, int unread, int highlights, long last_seen_eid, long min_eid, int joined, int archived, String status, int timeout, int ssl, int count, String contentDescription, Object fail_info) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			BufferListEntry e = data.get(position);
			View row = null;//convertView;  // no convertview is initialized
			ViewHolder holder;
			...
			if (row == null) {
				...
				holder.highlights = (TextView) row.findViewById(R.id.highlights, TextView.class);
				holder.unread = (LinearLayout) row.findViewById(R.id.unread, LinearLayout.class);
				holder.bufferbg = (LinearLayout) row.findViewById(R.id.bufferbg, LinearLayout.class);
				holder.icon = (ImageView) row.findViewById(R.id.icon, ImageView.class);
				holder.progress = (ProgressBar) row.findViewById(R.id.progressBar, ProgressBar.class);
				holder.addBtn = (ImageButton) row.findViewById(R.id.addBtn, ImageButton.class);
				holder.type = e.type;
            ...
            LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams)holder.unread.getLayoutParams(LinearLayout.LayoutParams.class);
            if(lp != null) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		topUnreadIndicator = (LinearLayout)view.findViewById(R.id.topUnreadIndicator, LinearLayout.class);
		...
		topUnreadIndicatorColor = (LinearLayout)view.findViewById(R.id.topUnreadIndicatorColor, LinearLayout.class);
		bottomUnreadIndicator = (LinearLayout)view.findViewById(R.id.bottomUnreadIndicator, LinearLayout.class);
		...
		bottomUnreadIndicatorColor = (LinearLayout)view.findViewById(R.id.bottomUnreadIndicatorColor, LinearLayout.class);
		listView = (ListView)view.findViewById(android.R.id.list, ListView.class);
