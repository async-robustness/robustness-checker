...
public class WhoisFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
    	...
    	extra = (TextView)v.findViewById(R.id.extra, TextView.class);
    	name = (TextView)v.findViewById(R.id.name, TextView.class);
    	mask = (TextView)v.findViewById(R.id.mask, TextView.class);
    	server = (TextView)v.findViewById(R.id.server, TextView.class);
    	timeTitle = (TextView)v.findViewById(R.id.timeTitle, TextView.class);
    	time = (TextView)v.findViewById(R.id.time, TextView.class);
        awayTitle = (TextView)v.findViewById(R.id.awayTitle, TextView.class);
        away = (TextView)v.findViewById(R.id.away, TextView.class);
    	ownerTitle = (TextView)v.findViewById(R.id.ownerTitle, TextView.class);
    	ownerChannels = (TextView)v.findViewById(R.id.ownerChannels, TextView.class);

    	adminTitle = (TextView)v.findViewById(R.id.adminTitle, TextView.class);
    	adminChannels = (TextView)v.findViewById(R.id.adminChannels, TextView.class);

    	opTitle = (TextView)v.findViewById(R.id.opTitle, TextView.class);
    	opChannels = (TextView)v.findViewById(R.id.opChannels, TextView.class);

    	halfopTitle = (TextView)v.findViewById(R.id.halfopTitle, TextView.class);
    	halfopChannels = (TextView)v.findViewById(R.id.halfopChannels, TextView.class);

    	voicedTitle = (TextView)v.findViewById(R.id.voicedTitle, TextView.class);
    	voicedChannels = (TextView)v.findViewById(R.id.voicedChannels, TextView.class);

    	channelsTitle = (TextView)v.findViewById(R.id.channelsTitle, TextView.class);
