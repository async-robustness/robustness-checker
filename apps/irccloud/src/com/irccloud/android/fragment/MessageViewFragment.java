...
public class MessageViewFragment extends ListFragment {
                ...
                synchronized(e) {
                    if(e.html != null) {
                        try {
							...
							throw se; // not to block SkipExceptions
						} catch (Exception ex) {
                        }
                    }
                }
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            synchronized (e) {
                ...
                if (row == null) {
                    ...
                    holder.timestamp = (TextView) row.findViewById(R.id.timestamp, TextView.class);
                    holder.message = (TextView) row.findViewById(R.id.message, TextView.class);
                    holder.expandable = (ImageView) row.findViewById(R.id.expandable, ImageView.class);
                    holder.failed = (ImageView) row.findViewById(R.id.failed, ImageView.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        connecting = v.findViewById(R.id.connecting, View.class);
		errorMsg = (TextView)v.findViewById(R.id.errorMsg, TextView.class);
		connectingMsg = (TextView)v.findViewById(R.id.connectingMsg, TextView.class);
		progressBar = (ProgressBar)v.findViewById(R.id.connectingProgress, ProgressBar.class);
    	statusView = (TextView)v.findViewById(R.id.statusView, TextView.class);
    	...
    	awayView = v.findViewById(R.id.away, View.class);
    	...
    	awayTxt = (TextView)v.findViewById(R.id.awayTxt, TextView.class);
    	unreadBottomView = v.findViewById(R.id.unreadBottom, View.class);
    	...
    	unreadBottomLabel = (TextView)v.findViewById(R.id.unread, TextView.class);
    	highlightsBottomLabel = (TextView)v.findViewById(R.id.highlightsBottom, TextView.class);

    	unreadTopView = v.findViewById(R.id.unreadTop, View.class);
    	...
    	unreadTopLabel = (TextView)v.findViewById(R.id.unreadTopText, TextView.class);
    	highlightsTopLabel = (TextView)v.findViewById(R.id.highlightsTop, TextView.class);
    	Button b = (Button)v.findViewById(R.id.markAsRead, Button.class);
    	...
    	globalMsgView = v.findViewById(R.id.globalMessageView, View.class);
    	globalMsg = (TextView)v.findViewById(R.id.globalMessageTxt, TextView.class);
    	b = (Button)v.findViewById(R.id.dismissGlobalMessage, Button.class);
    	b.setOnClickListener(new OnClickListener() {
    		@Override
    		public void onClick(View v) {
    			if(conn != null)
    	...
    	((ListView)v.findViewById(android.R.id.list, ListView.class)).setOnItemLongClickListener(new OnItemLongClickListener() {
        ...
        spinner = (ProgressBar)v.findViewById(R.id.spinner, ProgressBar.class);
        suggestionsContainer = v.findViewById(R.id.suggestionsContainer, View.class);
        suggestions = (GridView)v.findViewById(R.id.suggestions, GridView.class);
        headerViewContainer = getLayoutInflater(null).inflate(R.layout.messageview_header, null);
        headerView = headerViewContainer.findViewById(R.id.progress, View.class);
        backlogFailed = (TextView)headerViewContainer.findViewById(R.id.backlogFailed, TextView.class);
        loadBacklogButton = (Button)headerViewContainer.findViewById(R.id.loadBacklogButton, Button.class);
...
/*    	if(tapTimer != null)
        ...
        ViewGroup.MarginLayoutParams lp = (ViewGroup.MarginLayoutParams)headerView.getLayoutParams(ViewGroup.MarginLayoutParams.class);
        lp.topMargin = 0;
        headerView.setLayoutParams(lp);
        lp = (ViewGroup.MarginLayoutParams)backlogFailed.getLayoutParams(ViewGroup.MarginLayoutParams.class);
        lp.topMargin = 0;
        ...
        public void onClick(View arg0) {
	    	...
	    	if(adapter != null) {
	    		/*if(tapTimer != null) {
                    ...
                    // Timer t = new Timer(); // remove calls to Timer
	    			/*t.schedule(
							new TimerTask() {
								int position = pos;
    ...
    private class FormatTask extends AsyncTask<Void, Void, Void> {
	...
	private class StatusRefreshRunnable implements Runnable {
		...
		public StatusRefreshRunnable(String status, Object fail_info) {
			this.status = status;
	...
	private void update_status(String status, Object fail_info) {
    	...
    	if(status.equals("connected_ready")) {
    		...
    		try {
	    		statusView.setVisibility(View.VISIBLE);
	    		long seconds = 0; //(fail_info.get("timestamp").getAsLong() + fail_info.get("retry_timeout").getAsLong() - conn.clockOffset) - System.currentTimeMillis()/1000;
	    		if(seconds > 0) {
		    		String text = "Disconnected";
		    		/*if(fail_info.has("reason") && fail_info.get("reason").getAsString().length() > 0) {
                    ...
                    int attempts = 0; //fail_info.get("attempts").getAsInt();
                    if(attempts > 1)
