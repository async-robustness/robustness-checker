...
public class EditConnectionFragment extends DialogFragment {
	private class PresetServersAdapter extends BaseAdapter {
        ...
        public PresetServersAdapter(Activity context, ArrayList networks) {
            ctx = context;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (row == null) {
				...
				label = (TextView)row.findViewById(android.R.id.text1, TextView.class);
				row.setTag(label);
			} else {
		...
		public View getDropDownView(int position, View convertView, ViewGroup parent) {
			...
			if (row == null) {
				...
				holder.network = (TextView) row.findViewById(R.id.network, TextView.class);
				holder.hostname = (TextView) row.findViewById(R.id.hostname, TextView.class);
				holder.lock = (ImageView) row.findViewById(R.id.lock, ImageView.class);
	...
	private void init(View v) {
    	channelsWrapper = (LinearLayout)v.findViewById(R.id.channels_wrapper, LinearLayout.class);
		presets = (Spinner)v.findViewById(R.id.presets, Spinner.class);
		hostname = (EditText)v.findViewById(R.id.hostname, EditText.class);
		port = (EditText)v.findViewById(R.id.port, EditText.class);
		ssl = (CheckBox)v.findViewById(R.id.ssl, CheckBox.class);
		nickname = (EditText)v.findViewById(R.id.nickname, EditText.class);
		realname = (EditText)v.findViewById(R.id.realname, EditText.class);
		channels = (EditText)v.findViewById(R.id.channels, EditText.class);
		nickserv_pass = (EditText)v.findViewById(R.id.nickservpassword, EditText.class);
		join_commands = (EditText)v.findViewById(R.id.commands, EditText.class);
		server_pass = (EditText)v.findViewById(R.id.serverpassword, EditText.class);
    ...
    private class LoadNetworkPresets extends AsyncTask<Void, Void, ArrayList> {
        ...
        @Override
        protected void onPostExecute(ArrayList networks) {
