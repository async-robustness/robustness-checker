	...
	private final Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case NetworkConnection.EVENT_BADCHANNELKEY:
	        	...
	        	final EditText keyinput = (EditText)view.findViewById(R.id.textInput, EditText.class);
			...
			case NetworkConnection.EVENT_INVALIDNICK:
	        	...
	        	view = inflater.inflate(R.layout.dialog_textprompt,null);
	        	prompt = (TextView)view.findViewById(R.id.prompt, TextView.class);
	        	final EditText nickinput = (EditText)view.findViewById(R.id.textInput, EditText.class);
