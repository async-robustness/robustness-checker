...
public class EditConnectionActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().getCustomView().findViewById(R.id.action_cancel, View.class).setOnClickListener(new OnClickListener() {
        ...
        getSupportActionBar().getCustomView().findViewById(R.id.action_done, View.class).setOnClickListener(new OnClickListener() {
